...
## 14/03/2026 
Setup the pipeline for training on DINOv3 small with 2 blocks unfreeze on merged dataset of grayscale plantvillage + segmented plantdoc for 30 epochs. Completed training on DINOv3 small with 2 blocks unfreeze on grayscale plantvillage + segmented plantdoc merged dataset for 30 epochs. Got the validation accuracy of 84% and testing accuracy of 83%. Setup the pipeline for training on DINOv3 small with 2 blocks unfreeze on merged dataset of normal without the segmentation dataset for 30 epochs. Completed training on DINOv3 small with 2 blocks unfreeze on normal plantvillage and plantdoc merged dataset without segementation for 30 epochs. Got the validation accuracy of 90% and testing accuracy of 86.57%. Did some parameter changes on image size, loss function and setup the pipeline for training on DINOv3 small with 4 blocks unfreeze on merged dataset of normal without the segmentation dataset for 40 epochs. Completed training on DINOv3 small with 4 blocks unfreeze and some parameter changes on normal merged dataset of plantvillage and plantdoc. Got the validation accuracy of 91% and testing accuracy of 89%. Testing accuracy improved by 2 % from 87 to 89.

## 16/03/2026 
Changed the model version from DINOv3 small to DINOv3 large. Set up the pipeline to train the model using DINOv3 large on normal without segmented dataset for 30 epochs. Completed training the model using DINOv3 large on normal without segmented dataset for 30 epochs with 2 blocks unfreeze. Got the validation accuracy of 87% and testing accuracy of 90%. Trained the DINOv3 large with 4 blocks unfreeze on normal plantvillage + segmented plantdoc dataset for 30 epochs. Got the validation accuracy of 90% and testing accuracy of 91%. Validation accuracy improved by 3% and testing accuracy improved by 1%. Started training the model on merged segmented dataset of plantvillage and plantdoc with DINO v3 large with 4 blocks unfreeze. Completed training the model using DINOv3 large on segmented dataset for 30 epochs with 4 blocks unfreeze. Got the validation accuracy of 86% and testing accuracy of 89%. Started training the DINOv3 large model with the merged dataset of grayscale plantvillage + segmented plantdoc for 30 epochs with 4 blocks unfreeze. 

## 17/03/2026 
Completed training the model using DINOv3 large on merged dataset of grayscale plantvillage + segmented plantdoc for 30 epochs with 4 blocks unfreeze. Got the validation accuracy of 91% and testing accuracy of 90.39%. Started training the DINOv3 large model with normal without segmented merged dataset of plantvillage and plantdoc for 30 epochs with 4 blocks unfreeze. Completed training the model using DINOv3 large on normal without segmented merged dataset of plantvillage and plantdoc for 30 epochs with 4 blocks unfreeze. Got the validation accuracy of 92% and testing accuracy of 89%. Setup the code for training and testing the best model DINOv2 base on potato and tomato dataset.Started training the best model DINOv2 base on potato and tomato dataset for 30 epochs with blocks unfreeze. Completed training the best model DINOv2 base on potato and tomato dataset for 30 epochs with 2 blocks unfreeze.  Got the validation accuracy of 69.5% and testing accuracy of 69.2%.

## 18/03/2026 
Started training the best model DINOv2 base on potato and tomato dataset for 30 epochs with 4 blocks unfreeze and some parameter changes. Completed training the best model DINOv2 base on potato and tomato dataset for 30 epochs with 4 blocks unfreeze. Got the validation accuracy of 69.36% and testing accuracy of around 71%. Testing accuracy improved around 2%. Setup the code for training the best model DINOv2 base on rice disease dataset for 30 epochs with 2 blocks unfreeze. Started training the best model DINOv2 base on rice disease dataset for 30 epochs with 2 blocks unfreeze. Completed 9 epochs out of 30. Completed 17 epochs out of 30 on training the best model DINOv2 base on rice disease dataset for 30 epochs with 2 blocks unfreeze.
